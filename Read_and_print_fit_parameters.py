...
def get_paramters(tag,massORwidth):
    ...
    fitfile = R.TFile.Open(f"fitDiagnostics_MoW{massORwidth}{tag}.root")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-mOw', '--massOwidth', dest='mass_or_width_sample', default=[None], type=str, nargs=1, help="MC top mass or width  sample [data , 1695, 1715, 1735, 1755, 'data','190', '170', '150','130','090','075']")
    ...
    massORwidth  = args.mass_or_width_sample[0]
    year = args.Year[0]
    tag = Combine_year_tag[year]
    print(tag)

    
    mean_fit,sigmaG_fit = get_paramters(tag,massORwidth)
    print("\n=====================================")
