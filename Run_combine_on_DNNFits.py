...
for lep in ["mu","el"]:
        if(year=="Run2"):
                for yeardummy in ["UL2016preVFP" , "UL2016postVFP", "UL2017","UL2018"]:
                        update_rootfile = "shapes * "+lep+"jets /feynman/home/dphp/mk277705/work/HiggsCombine/HiggsCombine_Workspace_files/Hist_for_workspace/Combine_DNNFit_Input_t_ch_CAsi_histograms_"+yeardummy+"_"+lep+".root "+lep+"jets/$PROCESS "+lep+"jets/$PROCESS_$SYSTEMATIC"+"\n"
                ...
                update_rootfile = "shapes * "+lep+"jets /feynman/home/dphp/mk277705/work/HiggsCombine/HiggsCombine_Workspace_files/Hist_for_workspace/Combine_DNNFit_Input_t_ch_CAsi_histograms_"+year+"_"+lep+".root "+lep+"jets/$PROCESS "+lep+"jets/$PROCESS_$SYSTEMATIC"+"\n"
                print("\tshape are used from Root File: ",update_rootfile)
